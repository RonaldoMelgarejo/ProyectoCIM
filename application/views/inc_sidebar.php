        ...
        <aside class="left-sidebar" data-sidebarbg="skin6">
            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="<?php echo base_url('index.php/monitoreo/index'); ?>"
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="<?php echo base_url(); ?>index.php/monitoreo/setting"
